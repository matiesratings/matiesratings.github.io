...
if __name__ == "__main__":
    ...
    convert_csv_to_json(input_folder / "Player List (2025-08-13).csv", Path(output_folder / "all_players.json"))
    convert_matches(input_folder / "Match Results (2025-08-13).csv", Path(output_folder /"matches.json"))
